import { SITE, fold, closing, headHang, rows, pressWall } from "../helpers.mjs";
...
<section class="section defer">
  ${headHang("Clippings", "Add the article links as they are gathered; each row becomes a link once a URL is present.")}
...
${closing({ image: "ikem-dining-table", pos: "62% 50%", title: "Working on a story?", line: "Ikem speaks on the Los Angeles market, and on the particular real estate needs of athletes and entertainers.", label: "Press inquiries →", href: `mailto:${SITE.email}` })}
`,
};
